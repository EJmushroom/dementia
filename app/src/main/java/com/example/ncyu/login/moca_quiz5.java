...
public class moca_quiz5 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_moca_quiz5);
    }

    public void onClick(View v){
        switch (v.getId()){
            case R.id.moca_q5_next:
                Intent intent = new Intent();
                intent.setClass(moca_quiz5.this, moca_quiz5_ask.class);
