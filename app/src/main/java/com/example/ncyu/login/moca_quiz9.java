...
public class moca_quiz9 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_moca_quiz9);
    }
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.moca_q9_next:
                Intent intent = new Intent();
                intent.setClass(moca_quiz9.this, moca_quiz9_ask.class);
                ...
                bundle.putBooleanArray("quiz8_answer",bundle1.getBooleanArray("quiz8_answer"));

                intent.putExtras(bundle);
                startActivity(intent);

                moca_quiz9.this.finish();
                break;
        }
