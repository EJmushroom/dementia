...
public class moca_quiz4_ask extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_moca_quiz4_ask);
    }
    public void onClick(View v){
        switch (v.getId()){
            case R.id.moca_q4a_next:
                Intent intent = new Intent();
                intent.setClass(moca_quiz4_ask.this, moca_quiz4_ask2.class);
