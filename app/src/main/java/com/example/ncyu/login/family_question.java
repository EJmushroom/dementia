...
public class family_question extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_understand.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for(int i=0;i<7;i++){
                    if(Answer[i]==0){
                        Toast.makeText(family_question.this, "尚有題目未回答", Toast.LENGTH_SHORT).show();
                        flag=1; //尚有題目未答
                        break;
                    }
                }
                ...
                if(flag==0){
                    //皆有回答
                    //先恢復顏色
                    tv_FQ1.setTextColor(family_question.this.getResources().getColor(R.color.black));
                    tv_FQ2.setTextColor(family_question.this.getResources().getColor(R.color.black));
                    tv_FQ3.setTextColor(family_question.this.getResources().getColor(R.color.black));
                    tv_FQ4.setTextColor(family_question.this.getResources().getColor(R.color.black));
                    tv_FQ5.setTextColor(family_question.this.getResources().getColor(R.color.black));
                    tv_FQ6.setTextColor(family_question.this.getResources().getColor(R.color.black));
                    tv_FQ7.setTextColor(family_question.this.getResources().getColor(R.color.black));
                    ...
                    for(int i=0;i<7;i++){
                        if(Answer[i]!=CAnswer[i]){
                            ...
                            switch(i){
                                case 0:
                                    tv_FQ1.setTextColor(family_question.this.getResources().getColor(R.color.red));
                                    advise+="1 ";
                                    break;
                                case 1:
                                    tv_FQ2.setTextColor(family_question.this.getResources().getColor(R.color.red));
                                    advise+="2 ";
                                    break;
                                case 2:
                                    tv_FQ3.setTextColor(family_question.this.getResources().getColor(R.color.red));
                                    advise+="3 ";
                                    break;
                                case 3:
                                    tv_FQ4.setTextColor(family_question.this.getResources().getColor(R.color.red));
                                    advise+="4 ";
                                    break;
                                case 4:
                                    tv_FQ5.setTextColor(family_question.this.getResources().getColor(R.color.red));
                                    advise+="5 ";
                                    break;
                                case 5:
                                    tv_FQ6.setTextColor(family_question.this.getResources().getColor(R.color.red));
                                    advise+="6 ";
                                    break;
                                case 6:
                                    tv_FQ7.setTextColor(family_question.this.getResources().getColor(R.color.red));
                                    advise+="7 ";
                                    break;
                            }
                        }
                    ...
                    if(flag==2) {
                        Toast.makeText(family_question.this, "題目 " + advise + "有誤(題號紅色)\n" +
                                "請修正後再來", Toast.LENGTH_SHORT).show();
                    }
                    else if(flag==0){
                        //建立對話方框
                        AlertDialog.Builder builder = new AlertDialog.Builder(family_question.this);
                        ...
                        builder.setPositiveButton("是", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent in=new Intent(family_question.this,family_choose_test.class);
                        ...
                        builder.setNegativeButton("否", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                //建立SQLite物件
                                dbHelper = new MyDBHelper(family_question.this);
                                db = dbHelper.getWritableDatabase(); //開啟資料庫

                                //將SQLite資料庫family 資料表的 frequency屬性值改為1
                                ContentValues cv = new ContentValues();
                                cv.put("frequency",1);
                                int count = db.update("family",cv,"_id = 1",null);
                                db.close(); //關閉資料庫
        ...
        btn_FQ_back_FF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //new一個intent物件，並指定Activity切換的class
                Intent in=new Intent(family_question.this,family_function.class);
                //new一個Bundle物件，並將要傳遞的資料傳入
                Bundle bundle = new Bundle();
                bundle.putString("name",name_account.getString("name"));
                bundle.putString("account",name_account.getString("account"));
