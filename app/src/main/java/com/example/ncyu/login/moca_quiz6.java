...
public class moca_quiz6 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_moca_quiz6);
    }
    public void onClick2(View v){
        switch (v.getId()){
            case R.id.moca_q6_next:
                Intent intent = new Intent();
                intent.setClass(moca_quiz6.this, moca_quiz6_ask.class);
