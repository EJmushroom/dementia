...
public class moca_quiz7 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_moca_quiz7);
    }

    public void onClick2(View v) {
        switch (v.getId()) {
            case R.id.moca_q7_next:
                Intent intent = new Intent();
                intent.setClass(moca_quiz7.this, moca_quiz7_ask.class);
