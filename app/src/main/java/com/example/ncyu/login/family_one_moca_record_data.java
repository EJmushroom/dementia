...
import com.example.ncyu.login.mMySQL.MOCARecordDownloader;

public class family_one_moca_record_data extends AppCompatActivity {
    String urlAddress="http://ej30827.000webhostapp.com/one_moca_record_data_select.php";  //未寫
    ListView lv_MOCA;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv_MOCA=(ListView)findViewById(R.id.lv_one_moca_data);
        btn_moca_Back_Frecord=(ImageButton)findViewById(R.id.btn_moca_Back_Frecord);


        MOCARecordDownloader d=new MOCARecordDownloader(family_one_moca_record_data.this,urlAddress,lv_MOCA);
        d.execute();
        ...
        btn_moca_Back_Frecord.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(ANTestID.get("identity").equals("family")){
                    in=new Intent(family_one_moca_record_data.this,family_record.class);

                }else if(ANTestID.get("identity").equals("doctor")){
                    in=new Intent(family_one_moca_record_data.this,doctor_one_kind_scale.class);
                ...
                in.putExtras(bundle);
                startActivity(in);
                family_one_moca_record_data.this.finish();
            }
        });
    }
