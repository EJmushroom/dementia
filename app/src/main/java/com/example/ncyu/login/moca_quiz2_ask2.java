...
public class moca_quiz2_ask2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_moca_quiz2_ask2);
    }

    public void onClick(View v){
        switch (v.getId()){
            case R.id.moca_q2a2_next:
                Intent intent = new Intent();
                intent.setClass(moca_quiz2_ask2.this, moca_quiz2_ask2_draw.class);
