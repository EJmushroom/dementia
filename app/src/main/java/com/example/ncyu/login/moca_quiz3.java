...
public class moca_quiz3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_moca_quiz3);
    }

    public void onClick(View v){
        switch (v.getId()){
            case R.id.moca_q3_next:
                Intent intent = new Intent();
                intent.setClass(moca_quiz3.this, moca_quiz3_ask.class);
