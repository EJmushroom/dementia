...
public class moca_quiz7_ask extends AppCompatActivity {

    String quiz7_question[]=new String[3];
    String quiz7_answer[]=new String[3];
    TextView quiz7_quiz,quiz7_ans;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_moca_quiz7_ask);
        quiz7_question= getResources().getStringArray(R.array.moca_quiz7_ask_quiz);
        quiz7_answer=getResources().getStringArray(R.array.moca_quiz7_ask_answer);
        quiz7_quiz=(TextView)findViewById(R.id.quiz7_quiz);
        quiz7_ans=(TextView)findViewById(R.id.quiz7_ans);

        quiz7_quiz.setText(quiz7_question[0]);
        quiz7_ans.setText(quiz7_answer[0]);
    }
    public void onClick2(View v) {
        switch (v.getId()) {
            case R.id.moca_q7a_next:
                Intent intent = new Intent();
                intent.setClass(moca_quiz7_ask.this, moca_quiz7_ask2.class);
