...
public class map extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(map.this, "沒有獲得位置權限，無法取得當前位置", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK)
        {
            if(identity.getString("identity").equals("guest")){
                ...
                Intent in=new Intent(map.this,visitor_function.class);
                startActivity(in);
                map.this.finish();
            }
            ...
            {
                //new一個intent物件，並指定Activity切換的class
                Intent in=new Intent(map.this,family_function.class);
